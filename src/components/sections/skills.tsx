...
const SKILLS: readonly Skill[] = [
  ...
  { name: 'Express', icon: '/icons/expressjs.svg', darkIcon: '/icons/expressjs-dark.svg' },
  { name: 'Hono', icon: '/icons/hono.svg' },
  { name: 'MongoDB', icon: '/icons/mongodb.svg' },
  { name: 'Postgres', icon: '/icons/postgresql.svg' },
  { name: 'Prisma', icon: '/icons/prisma.svg', darkIcon: '/icons/prisma-dark.svg', small: true },
  ...
  { name: 'Tanstack', icon: '/icons/tanstack-light.svg', darkIcon: '/icons/tanstack-dark.svg' },
  ...
  { name: 'LangChain', icon: '/icons/langchain.svg', darkIcon: '/icons/langchain-dark.svg' },
  { name: 'Pinecone', icon: '/icons/pinecone.svg', darkIcon: '/icons/pinecone-dark.svg' },
  { name: 'OpenAI', icon: '/icons/chatgpt-light.svg', darkIcon: '/icons/chatgpt-dark.svg' },
  { name: 'Sanity CMS', icon: '/icons/sanity.svg' },
  { name: 'Posthog', icon: '/icons/posthog.svg', darkIcon: '/icons/posthog-dark.svg' },
  { name: 'Docker', icon: '/icons/docker.svg' },
  { name: 'Figma', icon: '/icons/figma.svg' },
  { name: 'Postman', icon: '/icons/postman.svg' },
  { name: 'Git', icon: '/icons/git.svg' },
  { name: 'Cloudflare', icon: '/icons/cloudflare.svg' },
  { name: 'Vercel', icon: '/icons/vercel.svg', darkIcon: '/icons/vercel-dark.svg', small: true },
  { name: 'AWS', icon: '/icons/aws.svg', darkIcon: '/icons/aws-dark2.svg' }
] as const
